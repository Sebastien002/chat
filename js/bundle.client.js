...
"use strict";
var getStats = function(e, n, t) {
function o() {
    i(function(e) {
        if (e && e.forEach) {
            e.forEach(function(e) {
                Object.keys(l).forEach(function(n) {
                    if ("function" == typeof l[n]) try {
                        l[n](e)
                    } catch (e) {
...
(r = "undefined" != typeof global ? global : null) && "undefined" == typeof window && "undefined" != typeof global && (global.navigator = {
    ...
    return e
}, r.HTMLVideoElement = function() {}), "undefined" == typeof location && (r.location = {
    protocol: "file:",
    href: "",
    hash: ""
...
}), "undefined" == typeof MediaStreamTrack && (r.MediaStreamTrack = function() {}), void 0 === s && (r.RTCPeerConnection = function() {}), r.window = global);
...
var d = ((navigator.connection || {}).type || "unknown").toString().toLowerCase(),
    c = {
        encryption: "sha-256",
        audio: {
            send: {
...
m = arguments[0], arguments[1] instanceof MediaStreamTrack && (e = arguments[1], n = arguments[2], t = arguments[3]);
var g = !1;
l.datachannel = function(e) {
    "datachannel" === e.type && (c.datachannel = {
        state: e.state
    })
    ...
    if ("audio" === e.mediaType) {
        var n = e.id.split("_").pop();
        if (!0 === e.isRemote && (n = "recv"), !1 === e.isRemote && (n = "send"), n) {
            if (-1 === c.audio[n].codecs.indexOf(e.googCodecName || "opus") && c.audio[n].codecs.push(e.googCodecName || "opus"), e.bytesSent) {
                var t = 0;
                c.internal.audio[n].prevBytesSent || (c.internal.audio[n].prevBytesSent = e.bytesSent);
                var o = e.bytesSent - c.internal.audio[n].prevBytesSent;
                c.internal.audio[n].prevBytesSent = e.bytesSent, t = o / 1024, c.audio[n].availableBandwidth = t.toFixed(1), c.audio.bytesSent = t.toFixed(1)
            }
            if (e.bytesReceived) {
                t = 0;
                c.internal.audio[n].prevBytesReceived || (c.internal.audio[n].prevBytesReceived = e.bytesReceived);
                o = e.bytesReceived - c.internal.audio[n].prevBytesReceived;
                c.internal.audio[n].prevBytesReceived = e.bytesReceived, t = o / 1024, c.audio.bytesReceived = t.toFixed(1)
            }
            if (e.googTrackId && -1 === c.audio[n].tracks.indexOf(e.googTrackId) && c.audio[n].tracks.push(e.googTrackId), e.googCurrentDelayMs) {
                t = 0;
    ...
    if ("video" === e.mediaType) {
        var n = e.id.split("_").pop();
        if (!0 === e.isRemote && (n = "recv"), !1 === e.isRemote && (n = "send"), n) {
            if (-1 === c.video[n].codecs.indexOf(e.googCodecName || "VP8") && c.video[n].codecs.push(e.googCodecName || "VP8"), e.bytesSent) {
                var t = 0;
                c.internal.video[n].prevBytesSent || (c.internal.video[n].prevBytesSent = e.bytesSent);
                var o = e.bytesSent - c.internal.video[n].prevBytesSent;
                c.internal.video[n].prevBytesSent = e.bytesSent, t = o / 1024, c.video[n].availableBandwidth = t.toFixed(1), c.video.bytesSent = t.toFixed(1)
            }
            if (e.bytesReceived) {
                t = 0;
                c.internal.video[n].prevBytesReceived || (c.internal.video[n].prevBytesReceived = e.bytesReceived);
                o = e.bytesReceived - c.internal.video[n].prevBytesReceived;
                c.internal.video[n].prevBytesReceived = e.bytesReceived, t = o / 1024, c.video.bytesReceived = t.toFixed(1)
            }
            if (e.googFrameHeightReceived && e.googFrameWidthReceived && (c.resolutions[n].width = e.googFrameWidthReceived, c.resolutions[n].height = e.googFrameHeightReceived), e.googFrameHeightSent && e.googFrameWidthSent && (c.resolutions[n].width = e.googFrameWidthSent, c.resolutions[n].height = e.googFrameHeightSent), e.googTrackId && -1 === c.video[n].tracks.indexOf(e.googTrackId) && c.video[n].tracks.push(e.googTrackId), e.framerateMean) {
                c.bandwidth.framerateMean = e.framerateMean;
                t = 0;
                c.internal.video[n].prevFramerateMean || (c.internal.video[n].prevFramerateMean = e.bitrateMean);
                o = e.bytesSent - c.internal.video[n].prevFramerateMean;
                c.internal.video[n].prevFramerateMean = e.framerateMean, t = o / 1024, c.video[n].framerateMean = o.toFixed(1)
            }
            if (e.bitrateMean) {
                c.bandwidth.bitrateMean = e.bitrateMean;
                t = 0;
                c.internal.video[n].prevBitrateMean || (c.internal.video[n].prevBitrateMean = e.bitrateMean);
                o = e.bytesSent - c.internal.video[n].prevBitrateMean;
                c.internal.video[n].prevBitrateMean = e.bitrateMean, t = o / 1024, c.video[n].bitrateMean = o.toFixed(1)
            }
    ...
    if ("googCandidatePair" === e.type || "candidate-pair" === e.type || "local-candidate" === e.type || "remote-candidate" === e.type) {
        if ("true" == e.googActiveConnection) Object.keys(c.internal.candidates).forEach(function(n) {
            var t = c.internal.candidates[n]; - 1 !== t.ipAddress.indexOf(e.googLocalAddress) && (c.connectionType.local.candidateType = t.candidateType, c.connectionType.local.ipAddress = t.ipAddress, c.connectionType.local.networkType = t.networkType, c.connectionType.local.transport = t.transport), -1 !== t.ipAddress.indexOf(e.googRemoteAddress) && (c.connectionType.remote.candidateType = t.candidateType, c.connectionType.remote.ipAddress = t.ipAddress, c.connectionType.remote.networkType = t.networkType, c.connectionType.remote.transport = t.transport)
        }), c.connectionType.transport = e.googTransportType, (n = c.internal.candidates[e.localCandidateId]) && n.ipAddress && (c.connectionType.systemIpAddress = n.ipAddress), (t = c.internal.candidates[e.remoteCandidateId]) && t.ipAddress && (c.connectionType.systemIpAddress = t.ipAddress);
        if ("candidate-pair" === e.type && !0 === e.selected && !0 === e.nominated && "succeeded" === e.state) var n = c.internal.candidates[e.remoteCandidateId],
            t = c.internal.candidates[e.remoteCandidateId];
...
l.remotecandidate = function(e) {
    ...
    if (u && "inbound-rtp" === e.type) {
        var n = e.mediaType || "audio",
            t = e.isRemote ? "recv" : "send";
        if (t) {
            if (e.bytesSent) {
                var o = 0;
                c.internal[n][t].prevBytesSent || (c.internal[n][t].prevBytesSent = e.bytesSent);
                var i = e.bytesSent - c.internal[n][t].prevBytesSent;
                c.internal[n][t].prevBytesSent = e.bytesSent, o = i / 1024, c[n][t].availableBandwidth = o.toFixed(1), c[n].bytesSent = o.toFixed(1)
            }
            if (e.bytesReceived) {
                o = 0;
                c.internal[n][t].prevBytesReceived || (c.internal[n][t].prevBytesReceived = e.bytesReceived);
                i = e.bytesReceived - c.internal[n][t].prevBytesReceived;
                c.internal[n][t].prevBytesReceived = e.bytesReceived, o = i / 1024, c[n].bytesReceived = o.toFixed(1)
            }
        }
    }
    ...
    if (u && "track" === e.type) {
        var n = !0 === e.remoteSource ? "send" : "recv";
        e.frameWidth && e.frameHeight && (c.resolutions[n].width = e.frameWidth, c.resolutions[n].height = e.frameHeight)
    }
};
var b = {
    audio: {
...
l.ssrc = function(e) {
    if (e.googCodecName && ("video" === e.mediaType || "audio" === e.mediaType) && "ssrc" === e.type) {
        var n = e.id.split("_").pop(); - 1 === b[e.mediaType][n].indexOf(e.ssrc) && b[e.mediaType][n].push(e.ssrc), c[e.mediaType][n].streams = b[e.mediaType][n].length
    }
}, o()
};
        ...
        if (i.srcObject = e, i.setAttribute("autoplay", !0), i.setAttribute("playsinline", !0), i.setAttribute("controls", !0), i.setAttribute("muted", !1), i.setAttribute("volume", 1), "Firefox" === DetectRTC.browser.name) {
            ...
            "oninactive" in i && (r = "inactive"), i.addEventListener(r, function() {
                if (currentUserMediaRequest.remove(e.idInstance), "local" === e.type) {
                    r = "ended", "oninactive" in e && (r = "inactive"), R.onSyncNeeded(e.streamid, r), t.attachStreams.forEach(function(n, o) {
...
function m(e) {
    ...
    function() {
        ...
        var A = !1;
        void 0 !== I && "getSources" in I ? A = !0 : t.mediaDevices && t.mediaDevices.enumerateDevices && (A = !0);
        var R = !1,
            x = !1,
            M = !1,
            P = !1,
                ...
                if (!t.enumerateDevices && window.MediaStreamTrack && window.MediaStreamTrack.getSources && (t.enumerateDevices = window.MediaStreamTrack.getSources.bind(window.MediaStreamTrack)), !t.enumerateDevices && t.enumerateDevices && (t.enumerateDevices = t.enumerateDevices.bind(t)), t.enumerateDevices) {
                    ...
                    t.enumerateDevices(function(t) {
                        t.forEach(function(e) {
                            ...
                            n[t.deviceId + t.label + t.kind] || ("audio" === t.kind && (t.kind = "audioinput"), "video" === t.kind && (t.kind = "videoinput"), t.deviceId || (t.deviceId = t.id), t.id || (t.id = t.deviceId), t.label ? ("videoinput" !== t.kind || O || (O = !0), "audioinput" !== t.kind || P || (P = !0)) : (t.isCustomLabel = !0, "videoinput" === t.kind ? t.label = "Camera " + (E.length + 1) : "audioinput" === t.kind ? t.label = "Microphone " + (k.length + 1) : "audiooutput" === t.kind ? t.label = "Speaker " + (T.length + 1) : t.label = "Please invoke getUserMedia once.", void 0 !== L && L.browser.isChrome && L.browser.version >= 46 && !/^(https:|chrome-extension:)$/g.test(location.protocol || "") && "undefined" != typeof document && "string" == typeof document.domain && document.domain.search && -1 === document.domain.search(/localhost|127.0./g) && (t.label = "HTTPs is required to get label of this " + t.kind + " device.")), "audioinput" === t.kind && (R = !0, -1 === k.indexOf(t) && k.push(t)), "audiooutput" === t.kind && (x = !0, -1 === T.indexOf(t) && T.push(t)), "videoinput" === t.kind && (M = !0, -1 === E.indexOf(t) && E.push(t)), _.push(t), n[t.deviceId + t.label + t.kind] = t)
                        }), void 0 !== L && (L.MediaDevices = _, L.hasMicrophone = R, L.hasSpeakers = x, L.hasWebcam = M, L.isWebsiteHasWebcamPermissions = O, L.isWebsiteHasMicrophonePermissions = P, L.audioInputDevices = k, L.audioOutputDevices = T, L.videoInputDevices = E), e && e()
                    })
                } else e && e();
            else e && e()
        }
        ...
        L.displayResolution = H, L.displayAspectRatio = (q = screen.width, Q = screen.height, W = function e(n, t) {
            ...
            V(e = e || function() {})
        }, L.MediaDevices = void 0 !== _ ? _ : [], L.hasMicrophone = R, L.hasSpeakers = x, L.hasWebcam = M, L.isWebsiteHasWebcamPermissions = O, L.isWebsiteHasMicrophonePermissions = P, L.audioInputDevices = k, L.audioOutputDevices = T, L.videoInputDevices = E;
        var z = !1;
...
function A(e) {
    ...
    function r(t, o) {
        ...
        "oninactive" in t && (i = "inactive"), t.addEventListener(i, function() {
            ...
            stream: t
        }, currentUserMediaRequest.mutex = !1, currentUserMediaRequest.queueRequests.length && A(currentUserMediaRequest.queueRequests.shift()), e.onGettingLocalMedia(t, o)
    }
}
            ...
            if (n && n.addEventListener) {
                if (void 0 === t || 1 == t) {
                    ...
                    "oninactive" in n && (i = "inactive"), n.addEventListener(i, function() {
                        R.onSyncNeeded(this.streamid, i)
                    }, !1)
                }
                n.mute = function(i, a) {
                    i = e(i), void 0 !== a && (t = a), void 0 !== i && "audio" != i || v(n, "audio").forEach(function(e) {
                        ...
                        e.enabled = !1
                    }), void 0 !== t && 1 != t || R.onSyncNeeded(n.streamid, "mute", i), o.streamEvents[n.streamid].muteType = i || "both", r(n, "mute", i)
                    ...
                    i = e(i), void 0 !== a && (t = a),
                        ...
                        }()), void 0 !== t && 1 != t || R.onSyncNeeded(n.streamid, "unmute", i), o.streamEvents[n.streamid].unmuteType = i || "both", r(n, "unmute", i)
                }
            }
        },
...
! function(t) {
    ...
    r.onGettingLocalMedia = function(e, n) {
        if (n = n || function() {}, l[e.streamid]) n();
            ...
            t.setStreamEndHandler(e), d(e, function(o) {
                o.id = e.streamid, o.muted = !0, o.volume = 0, -1 === t.attachStreams.indexOf(e) && t.attachStreams.push(e), void 0 !== R && R.setHandlers(e, !0, t), t.streamEvents[e.streamid] = {
                    stream: e,
                    type: "local",
                    mediaElement: o,
                    userid: t.userid,
        ...
        t.setStreamEndHandler(e, "remote-stream"), d(e, function(o) {
            o.id = e.streamid, void 0 !== R && R.setHandlers(e, !1, t), t.streamEvents[e.streamid] = {
                stream: e,
                type: "remote",
                userid: n,
        ...
        mandatory: {}
    }, t.iceServers = E.getIceServers(t), t.candidates = {
        host: !0,
        stun: !0,
        turn: !0
    }, t.iceProtocols = {
        ...
        o || (o = t.session), e || (e = t.mediaConstraints), A({
        ...
        if (e = e || {}, S.prototype.getSenders)
            if (e instanceof I) _(e, n, o);
            else {
                if (e instanceof g) return v(e, "video").length && _(v(e, "video")[0], n, !0), void(v(e, "audio").length && _(v(e, "audio")[0], n, !1));
    ...
    }, void 0 !== R && (t.StreamsHandler = R), t.onleave = function(e) {}, t.invokeSelectFileDialog = function(e) {
    ...
    }, void 0 !== R && (R.onSyncNeeded = function(e, n, o) {
    ...
    if (t.streamEvents = {
        ...
        }, t.getUserMediaHandler = A, t.multiPeersHandler = r, t.enableLogs = !0, t.setCustomSocketHandler = function(e) {
            void 0 !== o && (o = e)
        ...
        if (connection.extra = {
            ...
            if (connection.onFileProgress = function(e, n) {
                        ...
                        setTimeout(function() {
                            ...
                            $("." + classVideo).each(function() {
                                if ($(this).is(":visible")) {
                                    ...
                                    var n = $(this).position(),
                                        t = jQEngager.Event("RemoteSpanPosition", {
                                            sessionId: e,
                                            position: n
                                        });
                                    jQEngager(document).trigger(t)
                    ...
                    if (n.extra) {
                        ...
                        if ("conference" !== conferenceStyle) var i = o > 1 ? "49%" : "98%",
                            r = o > 1 ? "relative" : "absolute";
                        setTimeout(function() {
                            $("." + classVideo).each(function() {
                        ...
                        }, 1e3), 0 === o && e.handleCallTermination(), queryString.broadcast && !queryString.isAdmin && "local" !== n.type && 0 === o && (toggleError(smartVideoLocale.msgStore.broadcastStopped, 5e3), setTimeout(function() {
                            location.reload()
                        }, 1e3))
                    }
...
var n, t = {
    msgStore: {},
    persistMsgStore: function(t) {
        e.localStorage ? (localStorage.setItem("msgStore", JSON.stringify(t)), this.msgStore = t) : this.msgStore = t;
        var o = n.Event("LSLocaleUpdated");
        n(document).trigger(o)
    },
    setLanguage: function(e, o) {
        n.ajax({
            url: o + "locales/" + e + ".json",
            dataType: "json",
            success: function(e) {
                t.persistMsgStore(e)
            },
    ...
    init: function(t, o) {
        n = o;
        var i = "";
        e.localStorage && null !== (i = localStorage.getItem("msgStore")) ? (this.initMsgStore(t), this.msgStore = JSON.parse(i)) : this.initMsgStore(t)
    }
};
...
notifyHandler = function() {
    ...
    this.init = function() {
        ...
        if (!document.hasFocus()) {
            ...
            e.showNotification(t + " has requested a chat.")
        }
    }), jQEngager(document).on("EnterCustomerNotification", function(n) {
        if (!document.hasFocus()) {
            var t = n.name ? n.name : "Visitor";
            e.showNotification(t + " is waiting in room " + n.roomId)
        }
    ...
    jQuery(document).ready(function(n) {
        ...
        var i = function(e) {
            ...
            r = function() {
                if ("conference" == conferenceStyle) {
                        ...
                        if (queryString.isAdmin) {
                            ...
                            n("<li>" + i + s + '<span class="mx-10">' + names[t].name + o + "</span>" + a + c + l + blockIcon + "</li>").appendTo(d), n("#grant" + t).on("click", function(e) {
                                ...
                                1 == confirm(smartVideoLocale.msgStore.sureBlock) && (n.ajax({
                                    ...
                                    data: {
                                        type: "blockuser",
                                        username: names[n(this).attr("data-typeid")].username
                                    }
                    ...
                    e > 0 ? (n(".dw-chat-avatar").show(), n(".dw-chat-avatar").attr("src", peer_avatar), n("#peer_name_chat").html(peer_name), n("#showProfile").show()) : (n(".dw-chat-avatar").hide(), n("#peer_name_chat").html(""), n("#showProfile").hide())
                } else {
                    n("#visitors").empty();
                    e = 0;
                    for (var t in names) {
        ...
        var c = function() {
            ...
            E = function() {
                ...
                if (comm_controller.getVideoSessions() || n("#invideo").is(":visible") || n("#ng_info").is(":visible")) {
                    ...
                    if (k("chat"), !queryString.isAdmin && duration && datetime)
                        if (!_()) return !1;
                    if (!queryString.isAdmin && requirePass) return toggleNotification("", !1), n("#ng_info").show(), ui_handler.displayChatOnly(), ui_handler.setDisabled(!0), visitorName && n("#ng_caller_name").val(visitorName), svConfigs.entryForm.showEmail && n("#ng_caller_email").show(), svConfigs.entryForm.showAvatar && n("#ng_caller_avatar").show(), n("#ng_password").show(), n("#continue-button").off(), n("#continue-button").on("click", function() {
                        is_callerback = !1;
                        var e = {};
                        e.name = visitorName || n("#ng_caller_name").val(), n("#ng_caller_name").val() && (e.email = n("#ng_caller_name").val()), n("#ng_caller_avatar").val() && (e.avatar = n("#ng_caller_avatar").val()), e.password = n("#ng_password").val(), comm_controller.setCallerInfo(e, !1), localStorage.setItem("prdTmp", JSON.stringify(e))
                    }), !1;
                    ...
                    if (svConfigs.entryForm.enabled) {
                        var t = function() {
                            ...
                            svConfigs.serverSide && svConfigs.serverSide.loginForm ? isLsvAdmin ? (ui_handler.setDisabled(!0), n("#ng_info").show(), n.ajax({
                                ...
                                ui_handler.setDisabled(!1), n("#ng_info").hide(), comm_controller.setCallerInfo(e, !1), localStorage.setItem("prd", JSON.stringify(e)), "conference" == conferenceStyle && I()
                            }).fail(function() {
                                return !1
                                ...
                                return !1
                            })) : (localStorage.setItem("prd", JSON.stringify(e)), svConfigs.entryForm.private && requirePass ? e.password = n("#ng_password").val() : (n("#ng_info").hide(), n("#continue-button").off(), ui_handler.setDisabled(!1)), comm_controller.setCallerInfo(e, queryString.isAdmin), "conference" == conferenceStyle && I())
                        };
                        if (svConfigs.entryForm.required || svConfigs.entryForm.private) {
                            (svConfigs.entryForm.private && requirePass || svConfigs.serverSide.loginForm) && (isOnline = !1, n("#ng_password").show()), svConfigs.entryForm.showEmail && n("#ng_caller_email").show(), svConfigs.entryForm.showAvatar && n("#ng_caller_avatar").show(), i = function(e) {
                                ...
                                13 == e.keyCode && "" !== n("#ng_caller_name").val() && "" !== n("#ng_caller_email").val() && o.test(n("#ng_caller_email").val()) && t();
                                var i = !svConfigs.entryForm.showEmail || "" !== n("#ng_caller_email").val() && o.test(n("#ng_caller_email").val()),
        ...
        function M() {
            ...
            n.get(lsRepUrl + "pages/" + videoWidgetContainer + "?v=" + currVersion, function(t) {
                ...
                smartVideoLocale.init(s, jQuery), n(document).on("RemoteVideoSessions", function(e) {
                    ...
                    if (f(), localStorage.removeItem("prd"), localStorage.removeItem("hasPrivileges"), queryString.isAdmin) comm_controller.setDeleteAll(), n("#invideo").hide(), n("#ng_info").show(), n("#continue-button").on("click", function() {
                        ...
                        localStorage.setItem("prd", JSON.stringify(e)), comm_controller.setCallerInfo(e, queryString.isAdmin), n("#ng_info").hide(), I()
                    });
                    else {
                        var e = function() {
                ...
                var d = function() {
                    n(".bigvideo").each(function() {
                        if (n(this).is(":visible") && "conference" === svConfigs.videoScreen.videoContainerStyle) {
                            var e = n(this).attr("id");
                            n("#" + e).detach().appendTo("#video_container_small"), n("#" + e).removeClass("bigvideo"), n("#" + e).removeClass("bigvideoadd"), n("#" + e).addClass("sourcevideo");
                            var t = n(n("#" + e)).position();
                            n("#remoteVideoSpan" + e).remove();
                            var o = names[e] ? names[e].name : peer_name,
                                i = n("<h2 />", {
                                    id: "remoteVideoSpan" + e,
                                    class: "sourcevideospan"
                                });
                            i.css("left", t.left), i.css("top", t.top), i.appendTo(n("#video_container_small")), i.html(o)
                        }
                    })
                };
                n(document).off("MakeBigBroadcast"), n(document).on("MakeBigBroadcast", function(e) {
                    n(".sourcevideo").each(function() {
                        var e = n(this).attr("id");
                        n("#fullScreen").show(), n("#" + e).detach().appendTo("#video_container"), n("#" + e).removeClass("sourcevideo"), n("#" + e).addClass("bigvideo"), n("#" + e).addClass("bigvideoadd"), comm_controller.getVideoSessions() > 1 ? (n("#" + e).css("height", "85%"), n("#" + e).css("height", "85%")) : (n("#" + e).css("height", "98%"), n("#" + e).css("height", "98%"));
                        var t = n("#" + e).position();
                        if (t) {
                            n("#remoteVideoSpan" + e).remove();
                            var o = names[e] ? names[e].name : peer_name,
                            ...
                            i.css("left", t.left), i.css("top", t.top), i.appendTo(n("#video_container")), i.html(o)
                        }
                    })
                    ...
                    if (n("#" + t).is(":visible") && !n("#wd-widget-content-whiteboard").is(":visible"))
                        if (clearTimeout(timerVars[t]), svConfigs.videoScreen && "conference" === svConfigs.videoScreen.videoContainerStyle && jQEngager("#" + t)) {
                            if (!svConfigs.videoScreen.videoConference && !names[t].isAdmin && !queryString.isAdmin) return;
                            if (d(), !comm_controller.getScreenStreamConnections()) {
                                n("#fullScreen").show(), n("#" + t).detach().appendTo("#video_container"), n("#" + t).removeClass("sourcevideo"), n("#" + t).addClass("bigvideo"), n("#" + t).addClass("bigvideoadd"), comm_controller.getVideoSessions() > 1 ? (n("#" + t).css("height", "85%"), n("#" + t).css("height", "85%")) : (n("#" + t).css("height", "98%"), n("#" + t).css("height", "98%"));
                                var o = n("#" + t).position();
                                if (!o) return;
                                n("#remoteVideoSpan" + t).remove();
                                var i = names[t] ? names[t].name : peer_name,
                                    r = n("<h2 />", {
                                        id: "remoteVideoSpan" + t,
                                        class: "sourcevideospan"
                                    });
                                r.css("left", o.left), r.css("top", o.top), r.appendTo(n("#video_container")), r.html(i), n(".sourcevideo").each(function() {
                                    if (n(this).is(":visible") && "conference" === svConfigs.videoScreen.videoContainerStyle) {
                                        var e = n(this).attr("id");
                                        n("#remoteVideoSpan" + e).remove();
                                        var t = names[e] ? names[e].name : peer_name,
                                            o = n("#" + e).position();
                                        if (!o) return;
                                        var i = n("<h2 />", {
                                            id: "remoteVideoSpan" + e,
                                        ...
                                        i.css("left", o.left), i.css("top", o.top), i.appendTo(n("#video_container_small")), i.html(t)
                                    }
                                })
                            }
                ...
                var c, g, p, _, k, M = function() {
                    _ = null, n("#snapshotData").hide(), n(".recordinglink").attr("href", "")
                };
                svConfigs.videoScreen.getSnapshot && n("#snapshotLi").click(function() {
                    if (c = n(".bigvideo.bigvideoadd")[0], g = n("#snapshotCanvas")[0], 500, c) {
                        p = c.videoHeight / (c.videoWidth / 500), isNaN(p) && (p = 375);
                        var e = g.getContext("2d");
                        p ? (g.width = 500, g.height = p, e.drawImage(c, 0, 0, 500, p), _ = g.toDataURL("image/png"), n("#snapshotData").show(), n("#snapshotLink").attr("href", _), n("#snapshotLink").attr("download", peer_name + ".png"), n("#snapshotLink").click(function() {
                            M()
                        }), n(".close-but-wd-small").on("click", function() {
                            M()
                        })) : M()
                ...
                n(document).off("RemoteVideoStarted"), n(document).on("RemoteVideoStarted", function(e) {
                    ...
                    if (t && (t.src = "", t.srcObject = null), "conference" == conferenceStyle) !isChrome && !isFirefox || isiPhone || isAndroid || !queryString.isAdmin || 1 != svConfigs.recording.enabled || 0 != svConfigs.recording.autoStart || n(".fa-circle").show(), n("#permission_div").hide(), n("#video_back").hide(), stopIncomingCall(), n("#wd-widget-content-whiteboard").is(":visible") || (ui_handler.toggleVideoBox(!0), (isChrome || isFirefox) && !isiPhone && !isAndroid && queryString.isAdmin && svConfigs.recording.enabled && svConfigs.recording.autoStart && l()), x(comm_controller.getSessionId(), video_on), playEnterRoom();
                    else {
                    ...
                    video_on = !1, ui_handler.setVideoButton(), x(comm_controller.getSessionId(), !1), names[comm_controller.getSessionId()].video = !1, localStorage.setItem("prd", JSON.stringify(names[comm_controller.getSessionId()]))
                    ...
                    ui_handler.disableVideo(), video_on = !1, ui_handler.setVideoButton(), x(comm_controller.getSessionId(), !1)
                    ...
                    if (e.sessionId == comm_controller.getSessionId()) {
                        ...
                        (n = JSON.parse(n)).muted = !audio_on, localStorage.setItem("prd", JSON.stringify(n)), comm_controller.toggleAudio()
                    }
                ...
                }), n("#muteAttendee").on("click", function() {
                    ...
                    "conference" != conferenceStyle && (isOnline = !1, R())
                    ...
                    d(), ui_handler.toggleInstaWhiteboard(), n("#cleanCanvas").show(), (queryString.isAdmin || localStorage.getItem("hasPrivileges")) && comm_controller.startWhiteboard()
                    ...
                    var e = smartVideoLocale.msgStore.raiseHandText.replace("{{caller_name}}", names[comm_controller.getSessionId()].name);
                    n(".fa-hand-paper-o").closest("a").addClass("active"), svConfigs.videoScreen && svConfigs.videoScreen.waitingRoom ? toggleError(e, 5e3) : showMessage("", e, null, "raiseHand")
                }), 1 == svConfigs.whiteboard.enabled && (queryString.isAdmin && !svConfigs.videoScreen.videoFileStream && (n("#whiteboard_div").show(), n("#whiteboardLi").show()), loadScript("../js/canvas-designer-widget.js", function() {})), 1 == svConfigs.serverSide.roomInfo && queryString.isAdmin && n("#exitmeeting_div").show(), 1 == svConfigs.serverSide.feedback && loadScript("../js/jquery.rateit.js", function() {}), n(document).off("ChatMessage"), n(document).on("ChatMessage", function(e) {
                    var t = names[e.sessionId] ? names[e.sessionId].name : peer_name,
                ...
                n("#newdev_chat_message1").keyup(function(e) {
                    ...
                    E()
                }, 100) : R(), n(document).off("IncomingFileTransfer"), n(document).on("IncomingFileTransfer", function(e) {
                    if (e.sender) {
                    ...
                    isOnline = !0, requirePass = null != e.pass && e.pass, E()
                    ...
                    }, e.callerInfo && i(e), u()), isOnline = !0, requirePass = null != e.pass && e.pass, E(e.sessionId))
                    ...
                    !queryString.broadcast && svConfigs.videoScreen.separateScreenShare && d(), ui_handler.displayScreenShare(), n("#remoteScreen").show(), ui_handler.setScreenDisabled(!0)
                    ...
                    n("#hangupBroadcastButton").trigger("click"), f(), comm_controller.endMeeting(), A(!0)
                ...
                n(".wd-v-share").on("click", function() {
                    ...
                    isOnline ? (ui_handler.displayVideoOnly(), O()) : R()
