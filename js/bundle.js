...
var prevId, prevMsgP, prevBody, errorTimer, incomingAudio, incomingMessage, enterRoom, estimateDif = function(e) {
    ...
    getPrettyDate = function(e) {
        var n = new Date,
            ...
            r = new Date(1e3 * e),
            s = r.getFullYear(),
            a = ("0" + (r.getMonth() + 1)).slice(-2),
            c = ("0" + r.getDate()).slice(-2),
            d = ("0" + r.getHours()).slice(-2),
            u = ("0" + r.getMinutes()).slice(-2);
    ...
    showMessage = function(e, n, t, o, i, r) {
        if (n) {
            ...
            if (t = "" !== t && null !== t && "undefined" !== t && void 0 !== t ? t : "" === e ? "" : s, "conference" == conferenceStyle) {
                ...
                if (o = o || "", prevId && e == prevId) l = prevMsgP, c = prevBody;
                else {
                    if ((l = $("<div />", {
                            class: className
                ...
                var d;
                (d = $("<p />")).html(n), d.appendTo(c), (d = $("<p />", {
                    class: "meta"
                })).html('<time datetime="2018">' + t + "</time>"), d.appendTo(c), l.appendTo($("#chat-content")), $("#typing").html(""), prevId = e, prevMsgP = l, prevBody = c, (u = document.getElementById("chat-content")).scrollTop = 999999
            } else {
                var u, l = document.createElement("li"),
                    m = "left",
                    g = "",
                    f = "";
                if ("Me" === e || "Me~" == e.substring(0, 3)) {
                    ...
                    if ("Me~" == e.substring(0, 3))
                        if (e = e.substring(3, 300), p = " right-image", "img/small-avatar.jpg" !== i && i) f = '<img class="direct-chat-img ' + m + '" src="' + i + '" alt="" />';
                    ...
                    } o = o || "", l.setAttribute("data-system-attribue", o), l.innerHTML = '<div class="' + className + '">' + f + '<span class="' + g + '">' + e + '</span><span class="timestamp">' + t + "</span><div>" + n + "</div>", (u = document.getElementById("newdev_chat_ul1")).appendChild(l), u.scrollTop = 999999
            }
        }
    },
    saveChat = function(e, n, t, o, i, r) {
        var s = queryString.names ? queryString.names : svConfigs.agentName,
...
var RTCMultiConnection = function(e, n) {
            ...
            if (i.srcObject = e, i.setAttribute("autoplay", !0), i.setAttribute("playsinline", !0), i.setAttribute("controls", !0), i.setAttribute("muted", !1), i.setAttribute("volume", 1), "Firefox" === DetectRTC.browser.name) {
                ...
                "oninactive" in i && (r = "inactive"), i.addEventListener(r, function() {
                    if (currentUserMediaRequest.remove(e.idInstance), "local" === e.type) {
                        r = "ended", "oninactive" in e && (r = "inactive"), A.onSyncNeeded(e.streamid, r), t.attachStreams.forEach(function(n, o) {
    ...
    function m(e) {
        ...
        function() {
            ...
            var o = !!/Android|webOS|iPhone|iPad|iPod|BB10|BlackBerry|IEMobile|Opera Mini|Mobile|mobile/i.test(t.userAgent || ""),
                ...
                s = void 0 !== window.InstallTrigger,
                a = /^((?!chrome|android).)*safari/i.test(t.userAgent),
                c = !!window.chrome && !r,
            ...
            v && v.osName && "-" != v.osName ? (m = v.osName, g = v.osVersion) : l.any() && "Android" == (m = l.getOsName()) && (g = !!(p = (f = (f || t.userAgent).toLowerCase()).match(/android\s([0-9\.]*)/)) && p[1]);
            ...
            var M = !1;
            void 0 !== b && "getSources" in b ? M = !0 : t.mediaDevices && t.mediaDevices.enumerateDevices && (M = !0);
            var A = !1,
                x = !1,
                P = !1,
                O = !1,
            ...
            U.browser = function() {
                    ...
                    return i && (l = "Edge", m = t.userAgent.split("Edge/")[1]), -1 !== (o = m.search(/[; \)]/)) && (m = m.substring(0, o)), g = parseInt("" + m, 10), isNaN(g) && (m = "" + parseFloat(t.appVersion), g = parseInt(t.appVersion, 10)), {
                        fullVersion: m,
                        version: g,
                        name: l,
                        isPrivateBrowsing: !1
                ...
                }), U.browser["is" + U.browser.name] = !0, U.osName = m, U.osVersion = g;
            ...
            ["AudioContext", "webkitAudioContext", "mozAudioContext", "msAudioContext"].forEach(function(e) {
                V.isSupported || e in window && (V.isSupported = !0, window[e] && "createMediaStreamSource" in window[e].prototype && (V.isCreateMediaStreamSourceSupported = !0))
            }), U.isAudioContextSupported = V.isSupported, U.isCreateMediaStreamSourceSupported = V.isCreateMediaStreamSourceSupported;
            var Q = !1;
            U.browser.isChrome && U.browser.version > 31 && (Q = !0), U.isRtpDataChannelsSupported = Q;
            var F = !1;
            U.browser.isFirefox && U.browser.version > 28 ? F = !0 : U.browser.isChrome && U.browser.version > 25 ? F = !0 : U.browser.isOpera && U.browser.version >= 11 && (F = !0), U.isSctpDataChannelsSupported = F, U.isMobileDevice = o;
            var B = !1;
            t.getUserMedia ? B = !0 : t.mediaDevices && t.mediaDevices.getUserMedia && (B = !0), U.browser.isChrome && U.browser.version >= 46 && !/^(https:|chrome-extension:)$/g.test(location.protocol || "") && "undefined" != typeof document && "string" == typeof document.domain && document.domain.search && -1 === document.domain.search(/localhost|127.0./g) && (B = "Requires HTTPs"), "Nodejs" === U.osName && (B = !1), U.isGetUserMediaSupported = B;
            var q, W, _, $ = "";
            screen.width && ($ += (screen.width ? screen.width : "") + " x " + (screen.height ? screen.height : ""));
            U.displayResolution = $, U.displayAspectRatio = (q = screen.width, W = screen.height, _ = function e(n, t) {
                return 0 == t ? n : e(t, n % t)
            }(q, W), q / _ / (W / _)).toFixed(2), U.isCanvasSupportsStreamCapturing = C, U.isVideoSupportsStreamCapturing = S, "Chrome" == U.browser.name && U.browser.version >= 53 && (U.isCanvasSupportsStreamCapturing || (U.isCanvasSupportsStreamCapturing = "Requires chrome flag: enable-experimental-web-platform-features"), U.isVideoSupportsStreamCapturing || (U.isVideoSupportsStreamCapturing = "Requires chrome flag: enable-experimental-web-platform-features")), U.DetectLocalIPAddress = function(e, n) {
                if (U.isWebRTCSupported) {
                    ...
                    ! function(e, n) {
                        ...
                        if (!o) return;
                        var s = null;
                        "Chrome" === U.browser && U.browser.version < 58 && (s = {
                            optional: [{
                                RtpDataChannels: !0
                            }]
                        });
                        var a = svConfigs.iceServers,
                            c = new o(a, s);
                        ...
                        n ? n.match(w) ? e("Local: " + n, t = !1, o) : n.match(y) ? e("Public: " + n, t, o = !1) : e("Public: " + n, t, o) : e()
                    }, n)
                }
                ...
                j(e = e || function() {})
            }, U.MediaDevices = void 0 !== I ? I : [], U.hasMicrophone = A, U.hasSpeakers = x, U.hasWebcam = P, U.isWebsiteHasWebcamPermissions = D, U.isWebsiteHasMicrophonePermissions = O, U.audioInputDevices = k, U.audioOutputDevices = T, U.videoInputDevices = R;
            var G = !1;
            "undefined" != typeof document && "function" == typeof document.createElement && "setSinkId" in document.createElement("video") && (G = !0), U.isSetSinkIdSupported = G;
            var H = !1;
            U.browser.isFirefox && "undefined" != typeof mozRTCPeerConnection ? "getSenders" in mozRTCPeerConnection.prototype && (H = !0) : U.browser.isChrome && "undefined" != typeof webkitRTCPeerConnection && "getSenders" in webkitRTCPeerConnection.prototype && (H = !0), U.isRTPSenderReplaceTracksSupported = H;
            var z = !1;
            U.browser.isFirefox && U.browser.version > 38 && (z = !0), U.isRemoteStreamProcessingSupported = z;
            var J = !1;
            void 0 !== b && "applyConstraints" in b.prototype && (J = !0), U.isApplyConstraintsSupported = J;
            var Y = !1;
            U.browser.isFirefox && U.browser.version >= 43 && (Y = !0), U.isMultiMonitorScreenCapturingSupported = Y, U.isPromisesSupported = !!("Promise" in window), U.version = "1.3.9", void 0 === U && (window.DetectRTC = {});
            var X = window.MediaStream;
            void 0 === X && "undefined" != typeof webkitMediaStream && (X = webkitMediaStream), U.MediaStream = void 0 !== X && "function" == typeof X && Object.keys(X.prototype), U.MediaStreamTrack = void 0 !== b && Object.keys(b.prototype);
            var K = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection;
            U.RTCPeerConnection = void 0 !== K && Object.keys(K.prototype), window.DetectRTC = U, "undefined" != typeof module && (module.exports = U), "function" == typeof define && define.amd && define("DetectRTC", [], function() {
                return U
            })
    ...
    function I(e) {
        ...
        if (n.attachStreams.forEach(function(e) {
            ...
            try {
                var c = {
                    ...
                    iceTransportPolicy: n.iceTransportPolicy || a
                };
        ...
        var d = {
            OfferToReceiveAudio: !!s.length,
            OfferToReceiveVideo: !!s.length
        };
        e.localPeerSdpConstraints && (d = e.localPeerSdpConstraints), S.sdpConstraints = w(d);
        var u = {};
        o.ontrack = function(n) {
            if (n && "track" === n.type)
                if (n.stream = n.streams[n.streams.length - 1], n.stream.id || (n.stream.id = n.track.id), u[n.stream.id] && "Safari" !== DetectRTC.browser.name) n.track && (n.track.onended = function() {
        ...
        this.addRemoteCandidate = function(e) {
            o.addIceCandidate(new y(e)), isEdge && l && (l = !1, setTimeout(function() {
                o.addIceCandidate(null)
            }, 3e3))
        }, this.addRemoteSdp = function(e, t) {
            t = t || function() {}, "Safari" !== DetectRTC.browser.name && (e.sdp = n.processSdp(e.sdp)), o.setRemoteDescription(new E(e)).then(t, function(n) {
        ...
        }, e.remoteSdp && (e.remoteSdp.remotePeerSdpConstraints && (d = e.remoteSdp.remotePeerSdpConstraints), S.sdpConstraints = w(d), this.addRemoteSdp(e.remoteSdp, function() {
            h("createAnswer")
        })), "two-way" != n.session.audio && "two-way" != n.session.video && "two-way" != n.session.screen || (S.sdpConstraints = w({
    ...
    var k = function() {
        ...
        function o(e, n, t) {
            return function(e, n, t, o, i) {
                for (var r = -1 !== t ? t : e.length, s = n; s < r; ++s)
                    if (0 === e[s].indexOf(o) && (!i || -1 !== e[s].toLowerCase().indexOf(i.toLowerCase()))) return s;
                return null
            }(e, 0, -1, n, t)
        }
    ...
    function M(e) {
        ...
        function r(t, o) {
            ...
            "oninactive" in t && (i = "inactive"), t.addEventListener(i, function() {
                ...
                stream: t
            }, currentUserMediaRequest.mutex = !1, currentUserMediaRequest.queueRequests.length && M(currentUserMediaRequest.queueRequests.shift()), e.onGettingLocalMedia(t, o)
        }
    }
                ...
                if (n && n.addEventListener) {
                    if (void 0 === t || 1 == t) {
                        ...
                        "oninactive" in n && (i = "inactive"), n.addEventListener(i, function() {
                            A.onSyncNeeded(this.streamid, i)
                        }, !1)
                    }
                    n.mute = function(i, s) {
                        i = e(i), void 0 !== s && (t = s), void 0 !== i && "audio" != i || p(n, "audio").forEach(function(e) {
                            ...
                            e.enabled = !1
                        }), void 0 !== t && 1 != t || A.onSyncNeeded(n.streamid, "mute", i), o.streamEvents[n.streamid].muteType = i || "both", r(n, "mute", i)
                        ...
                        i = e(i), void 0 !== s && (t = s),
                            ...
                            }()), void 0 !== t && 1 != t || A.onSyncNeeded(n.streamid, "unmute", i), o.streamEvents[n.streamid].unmuteType = i || "both", r(n, "unmute", i)
                    }
                }
            },
    ...
    ! function(t) {
        ...
        r.onGettingLocalMedia = function(e, n) {
            if (n = n || function() {}, u[e.streamid]) n();
            else {
                u[e.streamid] = !0;
                try {
                    e.type = "local"
                ...
                t.setStreamEndHandler(e), c(e, function(o) {
                    o.id = e.streamid, o.muted = !0, o.volume = 0, -1 === t.attachStreams.indexOf(e) && t.attachStreams.push(e), void 0 !== A && A.setHandlers(e, !0, t), t.streamEvents[e.streamid] = {
                        stream: e,
                        type: "local",
                        mediaElement: o,
                        userid: t.userid,
            ...
            t.setStreamEndHandler(e, "remote-stream"), c(e, function(o) {
                o.id = e.streamid, void 0 !== A && A.setHandlers(e, !1, t), t.streamEvents[e.streamid] = {
                    stream: e,
                    type: "remote",
                    userid: n,
            ...
            n = n || function() {}, t.userid = e || a(), t.socket.emit("changed-uuid", t.userid, n)
            ...
            return v() ? e : "Safari" === DetectRTC.browser.name ? e : ("VP8" === t.codecs.video.toUpperCase() && (e = k.preferCodec(e, "vp8")), "VP9" === t.codecs.video.toUpperCase() && (e = k.preferCodec(e, "vp9")), "H264" === t.codecs.video.toUpperCase() && (e = k.preferCodec(e, "h264")), "G722" === t.codecs.audio && (e = k.removeNonG722(e)), "Firefox" === DetectRTC.browser.name ? e : ((t.bandwidth.video || t.bandwidth.screen) && (e = k.setApplicationSpecificBandwidth(e, t.bandwidth, !!t.session.screen)), t.bandwidth.video && (e = k.setVideoBitrates(e, {
            ...
            mandatory: {}
        }, t.iceServers = R.getIceServers(t), t.candidates = {
            host: !0,
            stun: !0,
            turn: !0
        }, t.iceProtocols = {
            ...
            o || (o = t.session), e || (e = t.mediaConstraints), M({
            ...
            if (b && b.prototype.applyConstraints) {
                var o;
                if (n) return t.streamEvents[n] && (o = t.streamEvents[n].stream), void y(o, e);
                t.attachStreams.forEach(function(n) {
                    y(n, e)
                })
            } else alert("track.applyConstraints is NOT supported in your browser.")
        }, t.replaceTrack = function(e, n, o) {
            if (e = e || {}, C.prototype.getSenders)
                if (e instanceof b) I(e, n, o);
                else {
                    if (e instanceof g) return p(e, "video").length && I(p(e, "video")[0], n, !0), void(p(e, "audio").length && I(p(e, "audio")[0], n, !1));
        ...
        }, void 0 !== A && (t.StreamsHandler = A), t.onleave = function(e) {}, t.invokeSelectFileDialog = function(e) {
        ...
        }, void 0 !== A && (A.onSyncNeeded = function(e, n, o) {
        ...
        if (t.streamEvents = {
            ...
            }, t.getUserMediaHandler = M, t.multiPeersHandler = r, t.enableLogs = !0, t.setCustomSocketHandler = function(e) {
                void 0 !== o && (o = e)
    ...
    comController = function() {
        ...
        this.init = function(t, o) {
            ...
            if (sessionForChat = getCookie("sessionForChat") ? getCookie("sessionForChat") : sessionId + i, "admin" === role && (sessionId = "admin"), queryString.isAdmin && (sessionId += "a"), facingMode = svConfigs.videoScreen.primaryCamera ? svConfigs.videoScreen.primaryCamera : "user", setCookie("sessionId", sessionId, 1), setCookie("sessionForChat", sessionForChat, 1), window.enableAdapter = !0, publicRoomIdentifier = "dashboard", tenant = "dashboard", (connection = new RTCMultiConnection).enableLogs = !!svConfigs.videoScreen.enableLogs && svConfigs.videoScreen.enableLogs, connection.iceServers = svConfigs.iceServers.iceServers, connection.socketURL = svConfigs.appWss, conferenceStyle = svConfigs.videoScreen && "conference" === svConfigs.videoScreen.videoContainerStyle ? "conference" : "simple", classVideo = "conference" === conferenceStyle ? "sourcevideo" : "bigvideo", videoElementContainer = "conference" === conferenceStyle ? "video_container_small" : "video_container", videoWidgetContainer = "conference" === conferenceStyle ? "w.html" : "widget.html", roomLinkPage = "conference" == conferenceStyle ? "r.html" : "room.html", connection.publicRoomIdentifier = publicRoomIdentifier, connection.onbeforeunload = function() {}, connection.session = {
                    ...
                    return e
                }, "undefined" != typeof names) var r = names[sessionId] ? names[sessionId].name : guestName(sessionId);
            ...
            if (connection.extra = {
                    ...
                    if (!0 !== n.data.typing)
                        ...
                        if ("voiceSpeaking" === n.data) {
                            c = jQEngager.Event("VoiceSpeaking", {
                                id: n.userid
                            });
                            jQEngager(document).trigger(c)
                        }
                        if ("voiceSilence" === n.data) {
                            c = jQEngager.Event("VoiceSilence", {
                                id: n.userid
                            });
                            jQEngager(document).trigger(c)
                        }
                        if (lsDesigner && "plz-sync-points" === n.data) lsDesigner.sync();
                            ...
                            if (jQEngager(document).trigger(c), queryString.isAdmin || localStorage.getItem("hasPrivileges") || e.startWhiteboard(), lsDesigner || e.startWhiteboard(), n.data.whiteboardData) {
                                var s = n.data.whiteboardData,
                                    a = screen.width / n.data.width;
                        ...
                        var c = jQEngager.Event("SendTyping", {
                            typing: !1
                        });
                        jQEngager(document).trigger(c)
                    } else {
                ...
                if (connection.onFileProgress = function(e, n) {
                        ...
                        }, s[e.uuid].progress.max = e.maxChunks
                        ...
                        if (svConfigs.videoScreen.enableLogs && console.log("videoConnection.onstream", t), videoConnection.videosContainer = document.getElementById(videoElementContainer), "local" === t.type) {
                            ...
                            var u = t.stream;
                            if ("srcObject" in s ? s.srcObject = u : s[navigator.mozGetUserMedia ? "mozSrcObject" : "src"] = navigator.mozGetUserMedia ? u : (window.URL || window.webkitURL).createObjectURL(u), videoConnection.videosContainer.appendChild(s), queryString.broadcast) {
                                var l;
                                o = jQEngager.Event("RemoteVideoStarted");
                                jQEngager(document).trigger(o), queryString.token ? toggleNotification(smartVideoLocale.msgStore.welcomeBroadcast, !0) : toggleNotification(smartVideoLocale.msgStore.incomingBroadcast, !0), void 0 !== (l = s.play()) && l.then(function() {
                            ...
                            setTimeout(function() {
                                $("." + classVideo).each(function() {
                                    $(this).is(":visible") && ($(this).css("width", c), $(this).css("position", d))
                                })
            ...
            this.updateListOfRooms = function(n) {
                ...
                n.forEach(function(n, o) {
                    n.participants.forEach(function(o, i) {
                        ...
                        if (r) {
                            var s = r.extra,
                                a = jQEngager("#visitors").find("#" + s.sessionId),
                                c = s.ua ? detect.parse(s.ua) : "",
                                d = c ? c.browser.name : "",
                                u = c ? c.os.name : "",
                                ...
                                g = '<section class="msger-lsv" id="simpleButton' + s.sessionId + '" style="display: none;">                            <header class="msger-lsv-header">                                <div class="msger-lsv-header-title">                                        ' + l + '                                </div>                                <div class="msger-lsv-header-options">                                        <a href="javascript:void(0);" title="" class="close-but-wd-small" id="closeSimpleChat' + s.sessionId + '"><span></span></a>                                </div>                        </header>                        <main class="msger-lsv-chat" id="contentChatsimple' + s.sessionId + '">                        </main>                        <form class="msger-lsv-inputarea" id="form' + s.sessionId + '">                                <input type="text" id="input' + s.sessionId + '" class="msger-lsv-input" placeholder="Enter your message...">                                <input type="hidden" id="nameChat' + s.sessionId + '" value="' + l + '">                                <button type="submit" class="msger-lsv-send-btn">Send</button>                        </form>                </section>';
                            if (a.length > 0) {
                                var f = a[0];
                                f.innerHTML = '<div class="col-sm-10 col-xs-10">                                                                        <div class="messages msg_receive">                                                                                <p>' + l + " " + s.referrer + " " + m + "<br/>" + u + " " + d + "</p>                                                                                                                                                        </div>                                                                </div>", jQEngager(a[0]).replaceWith(f)
                            } else m = '<a href="javascript:void(0);" id="chat' + s.sessionId + '">Start chat</a>', (f = document.createElement("div")).className = "row msg_container base_receive", f.id = s.sessionId, f.innerHTML = '<div class="col-sm-10 col-xs-10">                                                                        <div class="messages msg_receive">                                                                                <p>' + l + " " + s.referrer + " " + m + "<br/>" + u + " " + d + "</p>                                                                                                                                                        </div>                                                                </div>", jQEngager("#visitors").append(f), t++;
                            if ($("#chat" + s.sessionId).off("click"), $("#chat" + s.sessionId).click(function() {
                                ...
                                jQEngager("#chats-lsv-admin").append(g), $("#chat" + s.sessionId).click(function() {
                                    $("#simpleButton" + s.sessionId).show()
                            ...
                            if ("popup" == n.extra.role) {
                                var v = jQEngager("#visitors").find("#" + s.sessionId),
                                    h = jQEngager("#visitors").find("#room" + s.sessionId),
                                    C = !1;
                                if (jQEngager("#roomid_" + n.extra.roomId).html(n.extra.roomId + ' <img src="../img/online.png" alt="waiting to connect">'), n.participants.forEach(function(e, t) {
                                        ...
                                        var e = v.children().children().children(),
                                            t = {};
            ...
            var c = n || ("initVideo" === this.id ? "Video" : "Audio"),
                d = r ? {
                    deviceId: {
                        exact: r
                    }
            ...
            switch (s && jQEngager.extend(!0, u, s), c) {
                case "Video":
                    ...
                    break;
                case "Audio":
                    l = !1, streamConstraints = {
                        audio: d,
                        video: !1
                    };
                    break;
                default:
                    l = !0, streamConstraints = {
                        video: u,
                        audio: d
                    }
            }
            ...
            if (s && jQEngager.extend(!0, a, s), n) var c = o ? {
                deviceId: {
                    exact: o
                }
            } : {
